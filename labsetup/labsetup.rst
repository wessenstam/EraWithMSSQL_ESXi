...
-----------------------
Microsoft SQL Lab Setup
-----------------------

Welcome to the *Databases: Era with Microsoft SQL* bootcamp. This bootcamp is meant to provide you with first-hand experience to clearly illustrate why Nutanix is an ideal platform for Database workloads.
